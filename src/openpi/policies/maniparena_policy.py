...
class ManipArenaInputs(transforms.DataTransformFn):
    ...
    def __call__(self, data: dict) -> dict:
        ...
        if "low_level_prompt" in data:
            low_level_prompt = data["low_level_prompt"]
            if isinstance(low_level_prompt, bytes):
                low_level_prompt = low_level_prompt.decode("utf-8")
            inputs["low_level_prompt"] = low_level_prompt
