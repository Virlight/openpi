...
from typing import Any, List, Optional, Tuple, Union, Dict, Set, Callable
from transformers.models.qwen3_vl.modeling_qwen3_vl import (__name__, F, Callable, Any, Optional, torch, nn, init, ACT2FN, Cache, GenerationMixin, use_kernel_func_from_hub, FlashAttentionKwargs, ModelOutput, ROPE_INIT_FUNCTIONS, dynamic_rope_update, ALL_ATTENTION_FUNCTIONS, PreTrainedModel, Unpack, TransformersKwargs, can_return_tuple, is_flash_attention_requested, maybe_autocast, Qwen3VLConfig, Qwen3VLTextConfig, Qwen3VLVisionConfig, BaseModelOutputWithDeepstackFeatures, Qwen3VLModel, Qwen3VLPreTrainedModel, Qwen3VLCausalLMOutputWithPast, Qwen3VLForConditionalGeneration)
...
class Qwen3VLTextRotaryEmbedding(nn.Module):
    ...
    def forward(self, x, position_ids):
        return Qwen3VLTextRotaryEmbedding_forward(self, x=x, position_ids=position_ids)
...
class Qwen3VLTextRMSNorm(nn.Module):
    ...
    def forward(self, hidden_states: torch.Tensor) -> torch.Tensor:
        return Qwen3VLTextRMSNorm_forward(self, hidden_states=hidden_states)
...
class Qwen3VLTextMLP(nn.Module):
    ...
    def forward(self, x):
        return Qwen3VLTextMLP_forward(self, x=x)
